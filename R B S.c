...

{
   ...
   system("title ..................Developed by reza rahman.......................");
    ...
    insertfirst(1,"Pizza        ",8,250.00);
    insertlast(2,"French fries ",8,720.83);
    insertlast(3,"Chicken Grill",7,520.29);
    insertlast(4,"Burger       ",23,90.00);
    insertlast(5,"Sandwich     ",34,80.23);
    insertlast(6,"Nun-Bread    ",21,35.13);
    insertlast(7,"Coffee       ",45,35.50);
    insertlast(8,"Ice-Cream    ",46,70.23);
    insertlast(9,"Cold Drinks  ",73,20.13);
    insertlast(10,"Water       ",46,70.23);
